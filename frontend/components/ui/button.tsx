...
const buttonVariants = cva(
  "focus-visible:border-ring focus-visible:ring-ring/50 aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive dark:aria-invalid:border-destructive/50 rounded-md border border-transparent bg-clip-padding text-[0.95rem] font-medium focus-visible:ring-[3px] aria-invalid:ring-[3px] [&_svg:not([class*='size-'])]:size-4 inline-flex cursor-pointer items-center justify-center whitespace-nowrap transform-gpu transition-[background-color,border-color,color,box-shadow,transform,opacity] duration-150 ease-[cubic-bezier(0.22,1,0.36,1)] motion-reduce:transform-none disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none shrink-0 [&_svg]:shrink-0 outline-none group/button select-none",
  {
    variants: {
      variant: {
        default: "bg-primary text-primary-foreground shadow-[0_1px_2px_rgba(15,23,42,0.08)] hover:-translate-y-0.5 hover:bg-primary/85 hover:shadow-[0_10px_18px_rgba(15,23,42,0.14)] active:translate-y-px active:shadow-[0_2px_6px_rgba(15,23,42,0.12)]",
        outline: "border-border bg-background shadow-xs hover:-translate-y-0.5 hover:border-slate-300 hover:bg-muted/90 hover:text-foreground hover:shadow-[0_8px_16px_rgba(15,23,42,0.08)] active:translate-y-px active:bg-muted dark:bg-input/30 dark:border-input dark:hover:bg-input/50 aria-expanded:bg-muted aria-expanded:text-foreground",
        secondary: "bg-secondary text-secondary-foreground shadow-[0_1px_2px_rgba(15,23,42,0.05)] hover:-translate-y-0.5 hover:bg-secondary/85 hover:shadow-[0_8px_16px_rgba(15,23,42,0.08)] active:translate-y-px active:shadow-[0_2px_6px_rgba(15,23,42,0.08)] aria-expanded:bg-secondary aria-expanded:text-secondary-foreground",
        ghost: "hover:-translate-y-0.5 hover:bg-muted/90 hover:text-foreground hover:shadow-[0_8px_16px_rgba(15,23,42,0.06)] active:translate-y-px active:bg-muted dark:hover:bg-muted/50 aria-expanded:bg-muted aria-expanded:text-foreground",
        destructive: "bg-destructive/10 text-destructive focus-visible:border-destructive/40 focus-visible:ring-destructive/20 hover:-translate-y-0.5 hover:bg-destructive/18 hover:shadow-[0_10px_18px_rgba(220,38,38,0.12)] active:translate-y-px active:bg-destructive/22 dark:focus-visible:ring-destructive/40 dark:bg-destructive/20 dark:hover:bg-destructive/30",
